...
//***** MRReducerTask2 class description *****//
//first two arguments of Reducer class work for input, and last two arguments work for output
public class MRReducerTask2 extends Reducer <Text, Text, Text, IntWritable>
{
	...
	//context (object of Context class) here works to match the value generated by the map method to match correctly with Reducer class last two arguments i.e. Text and IntWritable
	...
	public void reduce(Text key, Iterable <Text> values, Context context) throws IOException, InterruptedException
	{
		...
		context.write(key, new IntWritable(countUnits)); //this line of code writes output ( e.g. (Samsung, 7), (Onida, 3) etc. to local fs of reduce machine
	}
